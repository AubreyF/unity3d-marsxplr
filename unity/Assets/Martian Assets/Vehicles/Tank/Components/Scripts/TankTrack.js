...
function OnCollisionStay(collision : Collision) {
	...
	if(collision.transform.root && collision.transform.root.gameObject.rigidbody) {
...
function gotDirt(hit : ContactPoint, collision : Collision) {
	...
	rigidbody.AddForceAtPosition(Quaternion.LookRotation(Vector3.Cross(transform.right, hit.normal)) * force, Vector3(/*hit.point.x*/transform.position.x,hit.point.y,hit.point.z) + transform.TransformDirection(Vector3.up * Game.Settings.tankGrip));
